...
public class TextBlocksTestGen
{
  ...
  public void basicExamples (final JPackage root) throws JCodeModelException
  {
    ...
    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "EMPTY", JExpr.textBlock ());
    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "ONE_LINE", JExpr.textBlock ().add ("a"));
    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "TWO_LINES", JExpr.textBlock ().add ("a\nb"));

    cl.field (JMod.PUBLIC_STATIC_FINAL,
              String.class,
    ...
    cl.field (JMod.PUBLIC_STATIC_FINAL,
              ...
              JExpr.textBlock ().add ("\"\"\"\n\"\"\""));
    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "FIVE_DQUOTES", JExpr.textBlock ().add ("\"".repeat (5)));
    cl.field (JMod.PUBLIC_STATIC_FINAL,
              String.class,
              "TWO_FIVE_DQUOTES_LINES",
              JExpr.textBlock ().add ("\"".repeat (5)).add ("\"".repeat (5)));

    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "ONE_LINE_ENDSPACE", JExpr.textBlock ().add ("a  "));
    cl.field (JMod.PUBLIC_STATIC_FINAL, String.class, "ONE_LINE_ENDTAB", JExpr.textBlock ().add ("a\t\t"));
    cl.field (JMod.PUBLIC_STATIC_FINAL,
              String.class,
              "TWO_LINES_ENDTAB",
