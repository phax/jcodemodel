...
public class JLazyTestGen
{
  ...
  public void testLazyClass (JPackage root) throws JCodeModelException
  {
    ...
    var syncinstance = new JLazy (lazyClass, Integer.class, "getSyncInstance").init (root.owner ()
                                                                                         .ref (JLazyTestGen.class)
                                                                                         .staticInvoke ("inc"));
    var syncstatic = new JLazy (lazyClass, Integer.class, "getSyncStatic")._static ()
                                                                          .init (root.owner ()
                                                                                     .ref (JLazyTestGen.class)
                                                                                     .staticInvoke ("inc"));
    var asyncinstance = new JLazy (lazyClass, Integer.class, "getASyncInstance").sync (false)
                                                                                .init (root.owner ()
                                                                                           .ref (JLazyTestGen.class)
                                                                                           .staticInvoke ("inc"));
    var asyncstatic = new JLazy (lazyClass, Integer.class, "getASyncStatic")._static ()
                                                                            .sync (false)
                                                                            .init (root.owner ()
                                                                                       .ref (JLazyTestGen.class)
                                                                                       .staticInvoke ("inc"));

    IJExpression sum = syncinstance.expr ()
