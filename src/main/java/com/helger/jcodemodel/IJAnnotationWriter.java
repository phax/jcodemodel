 ...
 * @param <A>
 *        Annotation type in use
 */
public interface IJAnnotationWriter <A extends Annotation>
{
  /**
   * @return the underlying annotation use object to which we are writing.
   */
  JAnnotationUse getAnnotationUse ();

  /**
   * @return the type of the annotation that this writer is writing.
   */
