 ...
 * <p>
 * See http://www.microsoft.com/globaldev/reference/sbcs/1252.htm for the
 * normative definition. This code depends on Sun internal package, so we have
 * to make sure it won't be executed on other JDKs.
 */
public final class MS1252Encoder extends SingleByteEncoder
{
  ...
  private final static short index1[] = { 0,
                                         256,
                                         461,
                                         403,
                                         403,
  ...
  {
    final char test = index2.charAt (index1[(c & 0xFF00) >> 8] + (c & 0xFF));
    return test != 0;
  }
