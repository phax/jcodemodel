...
class Surrogate
{
  ...
  public static class Parser
  {
    ...
    /**
     * Returns an unmappable-input result object, with the appropriate input
     * length, for the previously-parsed character.
     */
     ...
     *        The first character
     * @param in
     *        The source buffer, from which one more character will be consumed
     *        if c is a high surrogate
     * @return Either a parsed UCS-4 character, in which case the isPair() and
     *         increment() methods will return meaningful values, or -1, in
     *         which case error() will return a descriptive result object
     */
     ...
     *        The first character
     * @param ia
     *        The input array, from which one more character will be consumed if
  ...
  public static class Generator
  {
     ...
     *        The UCS-4 character
     * @param len
     *        The number of input bytes from which the UCS-4 value was
     *        constructed (used when creating result objects)
     * @param dst
     *        The destination buffer, to which one or two UTF-16 characters will
     *        be written
     * @return Either a positive count of the number of UTF-16 characters written
     *         to the destination buffer, or -1, in which case error() will
     ...
     *        constructed (used when creating result objects)
     * @param da
     *        The destination array, to which one or two UTF-16 characters will
     *        be written
     * @param dp
