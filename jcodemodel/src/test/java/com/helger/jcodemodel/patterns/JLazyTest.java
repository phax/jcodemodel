...
public class JLazyTest
{
  ...
  public void testExtractFieldName ()
  {
    ...
    Assert.assertEquals ("_5", JLazy.extractFieldName ("5"));
    Assert.assertEquals ("_int", JLazy.extractFieldName ("int"));
    Assert.assertEquals ("_class", JLazy.extractFieldName ("class"));
  }
